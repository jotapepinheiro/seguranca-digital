...
/**
 * @Schema(title="Systems Paginate", description="Lista de Sistemas com Paginação")
 *
 * @package App\Http\Responses\Systems
 */
class SystemsPaginateResponse
{
    /**
    ...
    /**
     * @Property(type="array", @Items(ref="#/components/schemas/SystemProperty"))
     *
     * @var array
     */
    public $data = [];
