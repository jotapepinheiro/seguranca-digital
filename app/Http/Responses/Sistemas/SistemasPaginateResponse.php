...
/**
 * @Schema(title="Sistemas Paginate", description="Lista de Sistemas com Paginação")
 *
 * @package App\Http\Responses\Sistemas
 */
class SistemasPaginateResponse
{
    /**
    ...
    /**
     * @Property(type="array", @Items(ref="#/components/schemas/SistemaProperty"))
     *
     * @var array
     */
    public $data = [];
